  ...
  <body class="hold-transition skin-blue sidebar-mini">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Daftar Risiko
            <small>Kelola Data Risiko</small>
          </h1>

          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-home"></i> Home</a></li>
            <li class="active">Daftar Risiko</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="row">
            <div class="col-xs-12">
              <a href="<?php echo base_url("")."Admin/tambah_risiko"; ?>"><button type="submit" class="btn btn-primary"> + Risiko baru</button></a>
              <br><br>
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Daftar Risiko</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php foreach ($risiko as $r) {
                       ...
                       ?>
                      <tr>
                        <td><?php echo $r->id_risiko; ?></td>
                        <td><?php echo $r->nama_risiko; ?></td>
                        ...
                        <td>
                          <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                              <li><a href="<?php echo base_url()."/Admin/updateRisk/".$r->id_risiko;  ?>">update</a></li>
                              <li><a href="<?php echo base_url()."/Admin/deleteRisk/".$r->id_risiko;  ?>">delete</a></li>
                            </ul>
                          </div>
                        </td>
                        </tr>
