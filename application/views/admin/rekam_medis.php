      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Rekam Medis Pasien</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="row">
            <div class="col-xs-12">
              <a href="<?php echo base_url("")."Admin/tambah_rekam_medis/".$nik; ?>"><button type="submit" class="btn btn-primary"> + data medis baru</button></a>
              <br><br>
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data Rekam Medis Pasien</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                        ...
                        <td>
                          <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                              <li><a href="<?php echo base_url()."/Admin/viewEditBlog/" ?>">hapus</a></li>
                              <li><a href="<?php echo base_url()."/Admin/deleteBlog/".$r->id_rm;  ?>">koreksi</a></li>
                            </ul>
                          </div>
                        </td>
                        </tr>
