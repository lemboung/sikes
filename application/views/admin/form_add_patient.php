          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
                <a href=<?php echo base_url()."Admin";?>
                  <i class="fa fa-address"></i> <span>Daftar Pasien</span>
                </a>
            </li>
            <li class=" treeview">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#"><i class="fa fa-address-card"></i> Daftar Pasien</a></li>
                ...
                <?php echo form_open_multipart('Admin/tambahPasien');?>
                  <div class="box-body">
                    <div class="form-group">
                      <label>NIK</label>
                      <input type="number" class="form-control" id="exampleInputEmail1" placeholder="Masukkan NIK" name="nik" required>
                    </div>
                    <div class="form-group">
                      <label>Nama</label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Pekerjaan" name="pekerjaan" required>
                    </div>
                    <div class="form-group">
