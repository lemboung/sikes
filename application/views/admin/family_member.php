          ...
          <div class="col-lg-6">
            <div class="box box-primary">
              <div class="box-header with-border">
                ...
                <a href="<?php echo base_url("")."Admin/tambah_data_ekonomi/".$idkk; ?>"><button type="submit" class="btn btn-primary"> + Data Ekonomi Keluarga</button></a></br></br>
          ...
          <div class="col-lg-6">
            <div class="box box-primary">
              <div class="box-header with-border">
                ...
                <a href="<?php echo base_url("")."Admin/tambah_data_Perilaku/".$idkk; ?>"><button type="submit" class="btn btn-primary"> + Data Perilaku Kesehatan</button></a></br></br>
          ...
          <div class="col-lg-6">
            <div class="box box-primary">
              <div class="box-header with-border">
                ...
                <a href="<?php echo base_url("")."Admin/tambah_data_kesehatan/".$idkk; ?>"><button type="submit" class="btn btn-primary"> + Data Sosial Kesehatan</button></a></br></br>
