  ...
  <body class="hold-transition skin-blue sidebar-mini">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Data Risiko Baru
            <small>Formulir data risiko penyakit pasien</small>
          </h1>

          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-home"></i> Home</a></li>
            <li><a href="#"><i class="fa fa-book"></i> Daftar Risiko</a></li>
            <li class="active">Data Risiko Baru</li>
          </ol>
        </section>
            ...
            <div class="col-md-push-3 col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Data Risiko Baru</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                ...
                <?php echo form_open_multipart('Admin/tambahPasien');?>
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama Risiko" name="nama_risiko" required>
                    </div>
                    <div class="form-group">
                      <label>Bobot Hitungan</label>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="keterangan" placeholder="Masukkan Keterangan" rows="4">
                      </textarea>
                    </div>
                  </div><!-- /.box-body -->
