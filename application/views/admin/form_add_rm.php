  ...
  <body class="hold-transition skin-blue sidebar-mini">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Data Baru Rekam Medis
            <small>Formulir Data Baru Rekam Medis Pasien</small>
          </h1>

          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-home"></i> Home</a></li>
            <li><a href="#"><i class="fa fa-address-card"></i> Rekam Medis Pasien</a></li>
            <li class="active">Data Baru Rekam Medis</li>
          </ol>
        </section>
        ...
        <section class="content">
          <div class="row">
            ...
            <div class="col-md-push-3 col-md-6">
              <div class="box box-primary">
                <div class="box-header with-border">
                  ...
                  <table>
                    <tbody>
                      <tr>
                        <th>Nama</th>  <td> :  <?php echo $nama; ?></td>
                      </tr>
                      <tr>
                        <th>Alamat</th> <td> :  <?php echo $alamat; ?></td>
                      </tr>
                      <tr>
                        <th>Umur</th> <td> :  <?php echo $umur->y." Tahun"; ?></td>
                      </tr>
                      <tr>
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Data Baru Rekam Medis</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <?php echo form_open_multipart('Admin/tambahPasien');?>
                  <div class="box-body">
                    <div class="form-group">
                      <label>Keluhan</label>
                      <textarea class="form-control" name="keluhan" placeholder="Masukkan Keluhan" rows="4">
                      </textarea>
                    </div>
                    <div class="form-group">
                      <label>Tindakan</label>
                      <textarea class="form-control" name="tindakan" placeholder="Masukkan Tindakan" rows="4" >
                      </textarea>
                    </div>
                    <div class="form-group">
                      <label>obat</label>
                      <textarea class="form-control" name="obat" placeholder="Masukkan obat" rows="4">
                      </textarea>
                    </div>
                    <div class="form-group">
                      <label>Saran</label>
                      <textarea class="form-control" name="saran" placeholder="Masukkan Saran" rows="4" >
                      </textarea>
                    </div>
                  </div><!-- /.box-body -->
